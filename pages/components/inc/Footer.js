  ...
  return(
    <footer className="footer">
      <div className="asociados">
        <img src="/images/logo-cemex.png" alt="WEBINARS EN CONCRETO INSTITUTO MEXICANO DEL CEMENTO Y DEL CONCRETO A.C." className="asociado" style={{ width: '95px'}} />
        ...
        <img src="/images/logo-cruzazul.png" alt="WEBINARS EN CONCRETO INSTITUTO MEXICANO DEL CEMENTO Y DEL CONCRETO A.C." className="asociado" style={{ width: '75px'}} />
      </div>
